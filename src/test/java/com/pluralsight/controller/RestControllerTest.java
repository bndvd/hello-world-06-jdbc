...
public class RestControllerTest {
	...
	public void testDelete() {
		...
		restTemplate.delete("http://localhost:8080/ride_tracker/delete/12", Object.class);
	}
	...
	public void testException() {
		...
		restTemplate.getForObject("http://localhost:8080/ride_tracker/invalidcall", Ride.class);
	}
